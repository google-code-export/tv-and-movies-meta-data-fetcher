...
/**
 * Used to test the {@link MP4JAudioTaggerManager} class.
 */
@SuppressWarnings("nls")
public class TestMP4JAudioTaggerManager {
	...
	/** The constructor */
	public TestMP4JAudioTaggerManager() {
...
//		Assert.assertEquals("Compilation: [cpil=false]",atoms.get(index++).toString());
	...
	protected IMP4Manager createMP4Manager() throws MP4Exception {
		IMP4Manager manager = new MP4JAudioTaggerManager();
...
//		film.setFilmUrl(new URL("http://www.imdb.com/title/tt0114814/"));
	...
	public void testImageConversion() throws Exception {
		IMP4Manager ap = createMP4Manager();
		File f = ap.getArtworkFile(TestMP4JAudioTaggerManager.class.getResource("testArtwork.jpeg"));

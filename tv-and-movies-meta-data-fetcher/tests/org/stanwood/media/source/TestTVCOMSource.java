...
public class TestTVCOMSource extends TestCase {
	...
	public void testEurekaReadShow() throws Exception {
		...
		Show show = source.getShow(new File("/tmp/blah"), SHOW_ID_EUREKA);
	...
	public void testEurekaReadEpisodes() throws Exception {
		...
		assertEquals("http://www.tv.com/eric-laneuville/person/9830/summary.html",episode.getDirectors().get(0).getLink());
		assertEquals(1,episode.getWriters().size());
		assertEquals("Thania St. John",episode.getWriters().get(0).getTitle());
		assertEquals("http://www.tv.com/thania-st.-john/person/426/summary.html",episode.getWriters().get(0).getLink());
		assertEquals(9,episode.getGuestStars().size());
		assertEquals("Ever Carradine",episode.getGuestStars().get(1).getTitle());
		assertEquals("http://www.tv.com/ever-carradine/person/5974/summary.html",episode.getGuestStars().get(1).getLink());
		assertEquals("Christopher Gauthier",episode.getGuestStars().get(2).getTitle());
		assertEquals("http://www.tv.com/christopher-gauthier/person/265916/summary.html",episode.getGuestStars().get(2).getLink());
		assertEquals("Vanya Asher",episode.getGuestStars().get(3).getTitle());
		assertEquals("http://www.tv.com/vanya-asher/person/597981/summary.html",episode.getGuestStars().get(3).getLink());
		assertEquals("Neil Grayston",episode.getGuestStars().get(4).getTitle());
		assertEquals("http://www.tv.com/neil-grayston/person/81764/summary.html",episode.getGuestStars().get(4).getLink());
		assertEquals("Barclay Hope",episode.getGuestStars().get(5).getTitle());
		assertEquals("http://www.tv.com/barclay-hope/person/38709/summary.html",episode.getGuestStars().get(5).getLink());
		assertEquals("David Richmond-Peck",episode.getGuestStars().get(6).getTitle());
		assertEquals("http://www.tv.com/david-richmond-peck/person/168186/summary.html",episode.getGuestStars().get(6).getLink());
		assertEquals("Julius Chapple",episode.getGuestStars().get(7).getTitle());
		assertEquals("http://www.tv.com/julius-chapple/person/267036/summary.html",episode.getGuestStars().get(7).getLink());
		assertEquals("Bridget Hoffman",episode.getGuestStars().get(8).getTitle());
		assertEquals("http://www.tv.com/bridget-hoffman/person/51407/summary.html",episode.getGuestStars().get(8).getLink());
	...
	public void testHeroesReadShow() throws Exception {		
		...
		Show show = source.getShow(new File("/tmp/blah"), SHOW_ID_HEROES);

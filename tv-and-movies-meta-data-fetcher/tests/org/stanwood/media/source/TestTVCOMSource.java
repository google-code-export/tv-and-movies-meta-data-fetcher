...
public class TestTVCOMSource extends TestCase {
	...
	public void testEurekaReadShow() throws Exception {
		...
		Show show = source.getShow( SHOW_ID_EUREKA, new URL("http://www.tv.com/eureka/show/58448/summary.html"));
	...
	public void testEurekaReadSeasons() throws Exception {
		...
		assertNotNull("Check the season was found",season);
		assertEquals("http://www.tv.com/eureka/show/"+SHOW_ID_EUREKA+"/episode.html?season=1",season.getListingUrl().toExternalForm());
		...
		assertEquals("http://www.tv.com/eureka/show/"+SHOW_ID_EUREKA+"/episode.html?season=2",season.getListingUrl().toExternalForm());
		assertEquals("http://www.tv.com/eureka/show/"+SHOW_ID_EUREKA+"/episode_guide.html?printable=1",season.getDetailedUrl().toExternalForm());
		assertEquals(2,season.getSeasonNumber());

		season = source.getSeason(show, 3);
		assertEquals("http://www.tv.com/eureka/show/"+SHOW_ID_EUREKA+"/episode.html?season=3",season.getListingUrl().toExternalForm());
		assertEquals("http://www.tv.com/eureka/show/"+SHOW_ID_EUREKA+"/episode_guide.html?printable=1",season.getDetailedUrl().toExternalForm());
	...
	public void testEurekaReadEpisodes() throws Exception {
		...
		assertEquals("http://www.tv.com/eureka/pilot/episode/784857/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
		...
		assertEquals("http://www.tv.com/eureka/many-happy-returns/episode/800578/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
		...
		assertEquals("http://www.tv.com/eureka/right-as-raynes/episode/836518/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
		...
		assertEquals("http://www.tv.com/eureka/once-in-a-lifetime/episode/868398/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
		...
		assertEquals("http://www.tv.com/eureka/phoenix-rising/episode/1038982/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
		...
		assertEquals("http://www.tv.com/eureka/a-night-at-global-dynamics-2/episode/1128794/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
		...
		assertEquals("http://www.tv.com/eureka/from-fear-to-eternity/episode/1203120/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
	...
	public void testHeroesSpecials() throws Exception {
		...
		assertEquals("http://www.tv.com/heroes/show/"+SHOW_ID_HEROES+"/episode.html?season=3",season.getListingUrl().toExternalForm());
		assertEquals("http://www.tv.com/heroes/show/"+SHOW_ID_HEROES+"/episode_guide.html?printable=1",season.getDetailedUrl().toExternalForm());
		assertEquals(3,season.getSeasonNumber());
		...
		assertEquals("http://www.tv.com/heroes/volume-three-villains-the-second-coming/episode/1181337/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
		...
		assertEquals("2008-09-22",df.format(episode.getDate()));
		assertEquals("http://www.tv.com/heroes/the-butterfly-effect/episode/1196088/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
		...
		assertEquals("2008-09-22",df.format(episode.getDate()));
		assertEquals("http://www.tv.com/heroes/heroes-countdown-to-the-premiere/episode/1228258/summary.html?tag=ep_guide;summary",episode.getSummaryUrl().toExternalForm());
